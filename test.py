    ...
    for k, i in enumerate(Sort_S[j]):
        ...
        if k == 0:
            for (o, m) in possibilities:
                start_date_possibilities.append(start_for_task(o, m, i, Sort_r[j]))
            ...
            for (o, m) in possibilities:
                if (j==3 and i==35 and m==5 and o==11):
                    start_date_possibilities.append(start_for_task(o, m, i, Bi[Sort_S[j][k - 1]] + p[Sort_S[j][k - 1]]))
                else:
                    start_date_possibilities.append(start_for_task(o, m, i, Bi[Sort_S[j][k - 1]] + p[Sort_S[j][k - 1]]))
...
SOLUTION.solution(Bi, Mi, Oi, path)
